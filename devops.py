...
https://github.com/judeheer-ursa/public-python-library-template

Do not change this script! Any fixes or updates to this script should be made
to https://github.com/judeheer-ursa/public-python-library-template
"""
import os
import subprocess
import sys
...
def _configure_git():
    ...
    _shell('git config --local user.email "eng@judeheer-ursa.com"')
    _shell('git config --local user.name "judeheer-ursa Devops"')
